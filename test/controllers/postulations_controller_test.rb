...
class PostulationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create postulation" do
    assert_difference("Postulation.count") do
      post postulations_url, params: { postulation: { name: @postulation.name, user_id: @postulation.user_id } }
    end
  ...
  test "should update postulation" do
    patch postulation_url(@postulation), params: { postulation: { name: @postulation.name, user_id: @postulation.user_id } }
