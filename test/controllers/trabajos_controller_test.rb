...
class TrabajosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabajo" do
    assert_difference("Trabajo.count") do
      post trabajos_url, params: { trabajo: { description: @trabajo.description, name: @trabajo.name, user_id: @trabajo.user_id } }
    end
  ...
  test "should update trabajo" do
    patch trabajo_url(@trabajo), params: { trabajo: { description: @trabajo.description, name: @trabajo.name, user_id: @trabajo.user_id } }
